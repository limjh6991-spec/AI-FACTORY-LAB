/* [project]/node_modules/realgrid/dist/realgrid-style.css [app-client] (css) */
.rg-root {
  color: #000;
...
.rg-checkbar-head-indeterminate {
  vertical-align: middle;
  background: url("data:image/svg+xml;base64,") center / 16px no-repeat;
  border: none;
  width: 16px;
  height: 16px;
}
...
.rg-fixed-body .rg-data-row, .rg-fixed-body .rg-alternate-row {
  background-color: #ededed;
}
...
.rg-button-action:hover:active, .rg-button-action:active:hover {
...
.rg-button-list:hover:active, .rg-button-list:active:hover {
...
.rg-button-calendar:hover:active, .rg-button-calendar:active:hover {
...
.rg-rowgroup-summary, .rg-rowgroup-filter-panel {
  background: #f3ebdb;
}
...
.rg-expanded-cell, .rg-collapsed-cell {
  margin-left: 18px;
}
...
.rg-focus {
  border: 2px solid rgba(242, 161, 110, .8);
}
...
.rg-focus-inner {
  border: 1px dotted rgba(61, 61, 61, .8);
}
...
.rg-rowhover, .rg-rowfocus, .rg-rowblock {
  background: rgba(205, 210, 217, .1) !important;
}
...
._rg-row-mover-block_, ._rg-row-mover-group_ {
...
.rg-selection {
  border: 1px solid rgba(229, 102, 21, .67);
  background: rgba(229, 102, 21, .2) !important;
}
...
.rg-bar-renderer-bar-right, .rg-bar-renderer-bar-top, .rg-bar-renderer-bar-bottom {
  background: #f76b1c;
}
...
.rg-icon-renderer, .rg-check-renderer {
  position: relative;
}
...
.rg-button-renderer-button {
  ...
  background: linear-gradient(#fff, #eaecef);
...
.rg-button-renderer-button:hover {
  ...
  background: linear-gradient(#edeff1, #fff);
...
.rg-sparkcolumn-renderer-chart, .rg-sparkcolumn-renderer-last {
  fill: #b6bbc3;
}
...
.rg-filter-list-viewport {
  ...
  background: #fff;
  border: 1px solid #9aa1ac;
  border-color: #b6bbc3 #9aa1ac #9aa1ac #b6bbc3;
  overflow: auto;
}
...
.rg-filter-list-viewport:-webkit-scrollbar-track {
...
.rg-filter-list-viewport:-webkit-scrollbar-track-piece {
  -webkit-box-shadow: none;
  background: #dcdfe4;
  border-radius: 0;
  padding: 5px;
...
.rg-multicheck-item:hover {
  background: rgba(229, 102, 21, .3) !important;
}

.rg-multicheck-selectitem {
  color: #7e8795;
  background: rgba(229, 102, 21, .6);
}

.rg-changed-marker {
  border: 3px solid rgba(0, 0, 0, 0);
  border-color: #eb394f rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #eb394f;
  width: 0;
  height: 0;
}
...
.rg-edgemarker-leftbottom {
  border: 3px solid rgba(0, 0, 0, 0);
  border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #eb394f #eb394f;
  width: 0;
  height: 0;
  display: block;
  position: absolute;
...
.rg-edgemarker-righttop {
  border: 3px solid #eb394f;
  border-color: #eb394f #eb394f rgba(0, 0, 0, 0) rgba(0, 0, 0, 0);
  width: 0;
  height: 0;
  display: block;
  position: absolute;
...
.rg-edgemarker-rightbottom {
  border: 3px solid #eb394f;
  border-color: rgba(0, 0, 0, 0) #eb394f #eb394f rgba(0, 0, 0, 0);
  width: 0;
  height: 0;
  display: block;
  position: absolute;
...
.rg-load-indicator {
  background: rgba(234, 236, 239, .5) url("data:image/svg+xml;base64,") center / 100px no-repeat;
  border: none;
  width: 100%;
  height: 100%;
  display: inline-block;
...
/*# sourceMappingURL=node_modules_realgrid_dist_realgrid-style_css_bad6b30c._.single.css.map*/