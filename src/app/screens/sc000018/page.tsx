...
export default function Screen000018() {
  const columnDefs = [
  {
    "headerName": "구분",
    "field": "division",
  ...
  const summaryData = [
  {
    ...
    "boh_amt": 16000000,
    "prod_in_qty": 1600,
    "prod_in_amt": 86000000,
    "other_in_qty": 70,
    "other_in_amt": 3700000,
    "out_qty": 1470,
    "out_amt": 79200000,
    "other_out_qty": 40,
    "other_out_amt": 2100000,
    "loss_qty": 35,
    "loss_amt": 1900000,
    "defect_rate": 2.3,
    "eoh_qty": 425,
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const url = `/api/screens/sc000018/data${queryString ? '?' + queryString : ''}`;
