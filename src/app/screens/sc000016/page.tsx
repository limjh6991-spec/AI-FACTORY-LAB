...
export default function Screen000016() {
  const columnDefs = [
  {
    "headerName": "자재구분",
    "field": "materialType",
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const url = `/api/screens/sc000016/data${queryString ? '?' + queryString : ''}`;
