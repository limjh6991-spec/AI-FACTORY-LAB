...
export default function Screen000017() {
  const columnDefs = [
  {
    "headerName": "구분",
    "field": "division",
  ...
  const summaryData = [
  {
    ...
    "boh_amt": 19000000,
    "prod_in_qty": 1680,
    "prod_in_amt": 91800000,
    "other_in_qty": 90,
    "other_in_amt": 4900000,
    "out_qty": 1600,
    "out_amt": 87500000,
    "other_out_qty": 55,
    "other_out_amt": 3000000,
    "loss_qty": 35,
    "loss_amt": 1900000,
    "defect_rate": 1.95,
    "eoh_qty": 430,
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const url = `/api/screens/sc000017/data${queryString ? '?' + queryString : ''}`;
