...
export default function SC_BI_ACCT_MSTMasterScreen() {
  // RealGrid 참조
  ...
  const fields = [
    ...
    { fieldName: "account_code", dataType: ValueType.TEXT },
    { fieldName: "account_name", dataType: ValueType.TEXT },
    { fieldName: "financial_statement_type", dataType: ValueType.TEXT },
    { fieldName: "cost_behavior_type", dataType: ValueType.TEXT },
    { fieldName: "is_manufacturing_cost", dataType: ValueType.TEXT }
  ];
